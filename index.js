...
ConsolePlugin.logMessages = function(warnings, errors,
    failOnWarning, failOnError, context, testInfo) {
  warnings.map(function(warning) {
    (failOnWarning ? context.addFailure : context.addWarning)(
        testInfo.name + ' - ' + warning.level.name + ': ' + warning.message);
  });
  errors.map(function(error) {
    (failOnError ? context.addFailure : context.addWarning)(
        testInfo.name + ' - ' + error.level.name + ': ' + error.message);
  });
};
 ...
 */
ConsolePlugin.prototype.postTest = function(_passed, testInfo) {
